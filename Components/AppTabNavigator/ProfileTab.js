...
import { Icon, Container, Content, Header, Left, Body, Right, Button, Image, Thumbnail } from 'native-base'
        ...
        return (
            <Container style={{ flex:1, backgroundColor: 'white'}}>
                ...
                <Header style={{backgroundColor:"#FFFFFF"}}>
                    ...
                    <Body><Text style={{fontSize:18, fontWeight:'900'}}>Rokwon</Text></Body>
                ...
                <Content>
                    <View style={{ flexDirection:'row', paddingTop: 10}}>
                        <View style={{flex:1, alignItems:'center'}}>
                            <Thumbnail source={{ uri: profile.profile_image }}
                        ...
                        <View style={{ flex: 3 }}>
                            ...
                            <View style={{ flexDirection:'row', justifyContent:'space-around'}}>
                                <View style={{ alignItems:'center' }}>
                                    <Text>{postCount}</Text>
                                    <Text style={{fontSize:10, color:'#999999'}}>posts</Text>
                                </View>
                                <View style={{ alignItems:'center' }}>
                                    <Text>{followingCount}</Text>
                                    <Text style={{fontSize:10, color:'#999999'}}>follower</Text>
                                </View>
                                <View style={{ alignItems:'center' }}>
                                    <Text>{followerCount}</Text>
                                    <Text style={{fontSize:10, color:'#999999'}}>following</Text>
                                </View>
                            </View>
                    ...
                    <View style={{paddingHorizontal:10, paddingVertical:10}}>
                        <Text style={{fontWeight:'bold'}}> Rokwon </Text>
